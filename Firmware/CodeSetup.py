...
class HackpadConfigGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("⛏ SpeedrunDeck Keyboard Configurator")
    ...
    def create_widgets(self):
        ...
        tk.Label(title_frame, text="⛏ SpeedrunDeck ⛏", 
                font=self.title_font, bg=self.bg_color, fg=self.text_color).pack()
        tk.Label(title_frame, text="SpeedrunDeck Keyboard Configurator", 
        ...
        # Footer
        footer = tk.Label(main_frame, text="Speedrun Faster With SpeedrunDeck! 🎮", 
